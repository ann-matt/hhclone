...
export default function VacancyCard({id, title, salary, experience, companyName, city, employmentType}: Props){

  const navigate = useNavigate();

    return (
    <Card shadow="sm" radius="md" ta="left" w={660} h={250} p={24} mb={24}>
      <Stack gap={16}>
        <Box>
        ...
        <Group gap={24}>
          <ViewButton onClick={() => navigate(`/vacancies/${id}`)}/>
          <ApplyButton />
        </Group>
      </Stack>
    </Card>
